...
List<RecommendStore> recommendStoreList = [
  RecommendStore(
      storeName: '네일가게',
      location: '좌동',
      description: '꼼꼼한 시술로 유지력 높은 네일샵입니다. 좌동에 위치하고 있습니다',
      commentCount: 1,
      likeCount: 8,
      comment: '너무 편하게 시술해주셔서 잠들었었네요 직모에 짧은 눈썹이라 펌이 잘 안되는 타입인데 너무 이쁘게 됐네요',
      commentUser: '이엘리아',
      storeImages: [
  ...
  RecommendStore(
      storeName: '빨래방/코인워시 우동점',
      location: '우동',
      description: '빨래방 / 크린토피아 코인워시 우동점 신설했습니다. 많은 이용 바랍니다.',
      commentCount: 11,
      likeCount: 5,
      comment: '처음 방문때 건조기 무료로 서비스 해주셔서 너무 감사하네요. 앞으로 자주 이용 합니다.',
      commentUser: '코인님',
      storeImages: [
