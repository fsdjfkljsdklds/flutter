...
String lifeTitle = '이웃과 함께 만드는 봅 간식 지도 마음까지 따뜻해지는 봄 간식을 만나보세요.';
...
List<NeighborhoodLife> neighborhoodLifeList = [
  ...
  NeighborhoodLife(
    ...
    userName: 'flutter',
    location: '중동',
    content: '롯데 3차 지나고 롯데캐슬 방향으로 재래시장 앞쪽 지나 혹시 에어팟 오른쪽 주우신 분 있나요 ㅜㅜ',
    contentImgUri: '',
    commentCount: 11,
    authCount: 8,
    date: '1일전',
  ...
  NeighborhoodLife(
    ...
    userName: '구름나드리',
    location: '우동',
    content: '밤부터 새벽까지 하던 토스트 아저씨 언제 다시 오나요 ㅜㅠ',
    contentImgUri: '',
    commentCount: 0,
    authCount: 7,
    date: '3시간전',
